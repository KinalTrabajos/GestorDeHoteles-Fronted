export const ConfirmDeleteModal = ({ isOpen, onClose, onConfirm, hotelName, imageUrl }) => {
    ...
    <div className="fixed inset-0  bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md text-center space-y-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800">
          ¿Está seguro de que desea eliminar el hotel <span className="text-red-600">"{hotelName}"</span>?
        </h2>
